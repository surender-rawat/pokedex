...
public class PokemonClient {
    ...
    /**
     * This calls Pokemon API to get basic information
     *
     * @param name
     * @return
     */
    @Retryable(maxAttemptsExpression = "#{${pokedex.resttemplate.retry.count}}", value = PokemonException.class, backoff = @Backoff(delayExpression = "#{${pokedex.resttemplate.backoffpolicy.delay.millisec}}", multiplierExpression = "#{${pokedex.resttemplate.backoffpolicy.multiplier}}"))
